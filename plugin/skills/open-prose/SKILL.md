...
description: |
  ...
  Write .prose programs to define multi-agent workflows with a self-evident syntax.
  Supports agents, parallel execution, loops, pipelines, error handling, and conditionals.
...
OpenProse is a domain-specific language for orchestrating AI agent sessions. It provides a declarative, self-evident syntax for defining multi-agent workflows that execute via Claude Code's subagent system.
...
grep -A 20 "## Parallel Blocks" ${CLAUDE_PLUGIN_ROOT}/skills/open-prose/prose.md

# Find error handling
grep -A 30 "## Error Handling" ${CLAUDE_PLUGIN_ROOT}/skills/open-prose/prose.md

# Find loop syntax
grep -A 20 "## Fixed Loops" ${CLAUDE_PLUGIN_ROOT}/skills/open-prose/prose.md

# Find pipeline operations
grep -A 20 "## Pipeline Operations" ${CLAUDE_PLUGIN_ROOT}/skills/open-prose/prose.md

# Find validation rules
grep -A 30 "## Validation Rules" ${CLAUDE_PLUGIN_ROOT}/skills/open-prose/prose.md
```
